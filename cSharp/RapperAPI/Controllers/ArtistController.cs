...
namespace RapperAPI.Controllers {
    ...
    public class ArtistController : Controller {
        ...
        {
            return allArtists.Join(allGroups, art => art.GroupId, group => group.Id, (a, g) => {a.Group = g; return a;}).Where(artist => artist.ArtistName == name).ToList();
        }
